...
/****************** responsive tabs ***************/
var Tabs={init:function(){this.bindUIfunctions();this.pageLoadCorrectTab()},bindUIfunctions:function(){$(document).on("click","ul.tabs a[href^='#']:not('.active')",function(e){Tabs.changeTab(this.hash);e.preventDefault()}).on("click","ul.tabs a.active",function(e){Tabs.toggleMobileMenu(e,this);e.preventDefault()})},changeTab:function(e){var t=$("[href="+e+"]");var n=$(e);t.addClass("active").parent().siblings().find("a").removeClass("active");n.addClass("active").siblings().removeClass("active");t.closest("ul").removeClass("open")},pageLoadCorrectTab:function(){this.changeTab(document.location.hash)},toggleMobileMenu:function(e,t){$(t).closest("ul").toggleClass("open")}};Tabs.init()
...
$(window).scroll(function() {
	...
	if (scroll >= 1)  {
		...
		$(".banner").removeClass("fixed");$(".logo-connscu").removeClass("morph");}
		});
...
$(window).scroll(function() {
	...
	if (scrolldept >= 1)  {
		...
		$(".department .banner").removeClass("fixed");$(".logo-connscu").removeClass("morph");}
		});
...
$("#nav-button").on("click",function(){$(".nav-main").toggleClass("active");$("#nav-button").toggleClass("active");});
...
if($(window).width() < 990){
	...
	$('#nav-wrap > li:has(.mega-dropdown) > a:first-child').click(function(e) {
		...
		$(this).parent('li').find('.mega-dropdown').addClass('active').slideToggle(500);
    });
...
/****************** Activate Tabs ***************/
$('#tab-container, #tab-container-sub').easytabs();
